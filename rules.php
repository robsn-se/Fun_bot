...
$rules = [
    [
        REQUESTS_KEY => ["hi", "hello", "hey", "привет","hi", "hello", "hey", "привет", "здарова", "здравствуй", "приветствую тебя человек", "добро пожаловать", "Моё почтение"],
        RESPONSES_KEY => [
    ...
    [
        REQUESTS_KEY => ["что делаешь", "че делаешь", "чем занимаешься", "чем занят"],
        RESPONSES_KEY => [
